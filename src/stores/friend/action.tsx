...
export const getPendingFriend = () => async (dispatch: any) => {
    ...
    try {
        ...
        const res = await axios.get(`${API_URL}/api/friends/get-pending`);
...
export const getUsersFriend = () => async (dispatch: any) => {
    ...
    try {
        ...
        const res = await axios.get(`${API_URL}/api/friends/get-all`);
...
export const getFriend = () => async (dispatch: any) => {
    ...
    try {
        ...
        const res = await axios.get(`${API_URL}/api/friends/get-friend`);
...
export const getFriendByUsername = (value: any) => async (dispatch: any) => {
    ...
    try {
        ...
        const res = await axios.get(`${API_URL}/api/friends/get-friend-by-name?filter=${value}`);
...
export const addFriend = (id: string) => async (dispatch: any) => {
    ...
    try {
        ...
        const res = await axios.post(`${API_URL}/api/friends/add-friend/${id}`);
...
export const confirmFriend = (id: any) => async (dispatch: any) => {
    dispatch(auth());
    try {
        await axios.post(`${API_URL}/api/friends/confirm/${id}`);
